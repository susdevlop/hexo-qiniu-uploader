...
function replaceCss(htmlContent,rootUrl)
{
    return htmlContent.replace(
        ...
        function (str, p1, p2) {
            ...
            return str.replace(p1, rootUrl + p1);
        }
    );
}
...
function lazyProcess(htmlContent) {
    ...
    htmlContent = replaceCss(htmlContent, this.config.cdn.img_url);
    return htmlContent;
  }
...
module.exports.processSheet = function (htmlContent) {
    return replaceCss.call(this,htmlContent, this.config.cdn.img_url)
};